...
void board_init(void)
{
    ...
    hal_partitions[HAL_PARTITION_APPLICATION].partition_length           = 0x7C000;    //500k bytes
    ...
    hal_partitions[HAL_PARTITION_CUSTOM_1].partition_description      = "Custom";
    hal_partitions[HAL_PARTITION_CUSTOM_1].partition_start_addr       = 0x0807c000;
    hal_partitions[HAL_PARTITION_CUSTOM_1].partition_length           = 0x1000;    //4 bytes
    ...
    hal_partitions[HAL_PARTITION_OTA_TEMP].partition_length              = 0x7C000; //500k bytes
