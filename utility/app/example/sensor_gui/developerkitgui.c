...
extern volatile char g_wifi_connect;
...
extern void sensor_cloud_test(void *arg);
...
int application_start(int argc, char *argv[])
{
    ...
    int ret =aos_task_new("sensor_cloud_test", sensor_cloud_test, NULL, 8192);
    gui_init();
...
void gui_init(void)
{
    ...
    int ret = aos_task_new("littlevgl_refresh_task", littlevgl_refresh_task, NULL, 4096);
